...
> Snapshot 1

    {
      ...
      path: 'contracts/__upgradeable__/ClassInheritance.sol',
      source: `pragma solidity ^0.6.0;␊
      import "../ClassInheritance.sol";␊
...
> Snapshot 1
    ...
    {
      fileName: 'Deep.sol',
      path: 'contracts/__upgradeable__/one/two/three/Deep.sol',
      source: `pragma solidity ^0.6.0;␊
      ␊
...
> Snapshot 1

    {
      ...
      path: 'contracts/__upgradeable__/DiamondInheritance.sol',
      source: `pragma solidity ^0.6.0;␊
...
> Snapshot 1

    {
      ...
      path: 'contracts/__upgradeable__/ElementaryTypes.sol',
      source: `pragma solidity ^0.6.0;␊
      import "../ElementaryTypes.sol";␊
      import "./Initializable.sol";␊
      ␊
...
> Snapshot 1

    {
      ...
      path: 'contracts/__upgradeable__/ElementaryTypesWithConstructor.sol',
      source: `pragma solidity ^0.6.0;␊
      import "../ElementaryTypesWithConstructor.sol";␊
      import "./Initializable.sol";␊
      ␊
...
> Snapshot 1

    {
      ...
      path: 'contracts/__upgradeable__/Imported.sol',
      source: `pragma solidity ^0.6.0;␊
      import "../Imported.sol";␊
      import "./Initializable.sol";␊
      ␊
...
> Snapshot 1
    ...
    {
      fileName: 'Local.sol',
      path: 'contracts/__upgradeable__/Local.sol',
      source: `pragma solidity ^0.6.0;␊
      ␊
      import "./Imported.sol";␊
      import "../Local.sol";␊
...
> Snapshot 1

    {
      ...
      path: 'contracts/__upgradeable__/Override.sol',
      source: `pragma solidity ^0.6.0;␊
      import "../Override.sol";␊
      import "./Initializable.sol";␊
      ␊
...
> Snapshot 1

    {
      ...
      path: 'contracts/__upgradeable__/SimpleInheritance.sol',
      source: `pragma solidity ^0.6.0;␊
      import "../SimpleInheritance.sol";␊
      import "./Initializable.sol";␊
      ␊
...
> Snapshot 1

    {
      ...
      path: 'contracts/__upgradeable__/StringConstructor.sol',
      source: `pragma solidity ^0.6.0;␊
      import "../StringConstructor.sol";␊
      import "./Initializable.sol";␊
      ␊
