...
> Snapshot 1
    ...
    ␊
        uint256 transient t;␊
        uint256 transient u;␊
        /// @custom:storage-location erc7201:openzeppelin.storage.C12␊
        struct C12Storage {␊
            uint256 x;␊
            uint256 y;␊
        }␊
    ␊
        // keccak256(abi.encode(uint256(keccak256("openzeppelin.storage.C12")) - 1)) & ~bytes32(uint256(0xff))␊
        bytes32 private constant C12StorageLocation = 0xcb060369b9198ce596a180382c90e141db20115e7ca5d9e8248cdde0771cd600;␊
    ␊
        function _getC12Storage() private pure returns (C12Storage storage $) {␊
            assembly {␊
                $.slot := C12StorageLocation␊
            }␊
        }␊
    ␊
    ...
    ␊
        ...
        function sum() public view returns (uint256) {␊
            C12Storage storage $ = _getC12Storage();␊
            return $.x + t + $.y + u;␊
        }␊
    }␊
    `
