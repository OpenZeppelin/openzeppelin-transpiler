...
## namespace override with @custom:oz-transpile-namespace
...
> Snapshot 1
    ...
    ␊
        ...
        /// @custom:storage-location erc7201:openzeppelin.storage.OverriddenName␊
        struct OverriddenNameStorage {␊
            address x;␊
        }␊
    ␊
        // keccak256(abi.encode(uint256(keccak256("openzeppelin.storage.OverriddenName")) - 1)) & ~bytes32(uint256(0xff))␊
        bytes32 private constant OverriddenNameStorageLocation = 0xcffdab5b81a0402dcf544e183e1580d63ecda1efe0a183d84874372eb9f36f00;␊
    ␊
        function _getOverriddenNameStorage() private pure returns (OverriddenNameStorage storage $) {␊
            assembly {␊
                $.slot := OverriddenNameStorageLocation␊
            }␊
        }␊
    }␊
    ␊
    ...
    contract NamespaceOverride2 {␊
        /// @custom:storage-location erc7201:openzeppelin.storage.OverriddenName2␊
        struct OverriddenName2Storage {␊
            address x;␊
        }␊
    ␊
        // keccak256(abi.encode(uint256(keccak256("openzeppelin.storage.OverriddenName2")) - 1)) & ~bytes32(uint256(0xff))␊
        bytes32 private constant OverriddenName2StorageLocation = 0x1e1bbecf9180e2999f5629b303bca74a5531256eb60c634461387c14453aa600;␊
    ␊
        function _getOverriddenName2Storage() private pure returns (OverriddenName2Storage storage $) {␊
            assembly {␊
                $.slot := OverriddenName2StorageLocation␊
            }␊
        }␊
    ...
    ␊
        function __NamespaceOverride2_init_unchained() internal onlyInitializing {␊
            OverriddenName2Storage storage $ = _getOverriddenName2Storage();␊
            $.x = msg.sender;␊
        }␊
    }␊
    ␊
    ...
    ␊
        function __NamespaceOverride3_init_unchained() internal onlyInitializing {␊
            OverriddenName3Storage storage $ = _getOverriddenName3Storage();␊
            $.x = msg.sender;␊
        }␊
        /// @custom:storage-location erc7201:openzeppelin.storage.OverriddenName3␊
        struct OverriddenName3Storage {␊
            address x;␊
        }␊
    ␊
        // keccak256(abi.encode(uint256(keccak256("openzeppelin.storage.OverriddenName3")) - 1)) & ~bytes32(uint256(0xff))␊
        bytes32 private constant OverriddenName3StorageLocation = 0x9c22d233730e458dc0a290a7a139c5ffb90500729802ae9e40c6e44679e89d00;␊
    ␊
        function _getOverriddenName3Storage() private pure returns (OverriddenName3Storage storage $) {␊
            assembly {␊
                $.slot := OverriddenName3StorageLocation␊
            }␊
        }␊
    }␊
    ␊
    ...
    contract NamespaceOverride4 {␊
        /// @custom:storage-location erc7201:openzeppelin.storage.OverriddenName4␊
        struct OverriddenName4Storage {␊
            uint x; // a comment␊
    ␊
            uint y;␊
        }␊
    ␊
        // keccak256(abi.encode(uint256(keccak256("openzeppelin.storage.OverriddenName4")) - 1)) & ~bytes32(uint256(0xff))␊
        bytes32 private constant OverriddenName4StorageLocation = 0x73ae28dc7a1ec7dad715b21082019e10211e75d91ae08da249067eecdff68800;␊
    ␊
        function _getOverriddenName4Storage() private pure returns (OverriddenName4Storage storage $) {␊
            assembly {␊
                $.slot := OverriddenName4StorageLocation␊
            }␊
        }␊
    ␊
    ...
    ␊
        ...
        function f() public {␊
            OverriddenName4Storage storage $ = _getOverriddenName4Storage();␊
            $.x = 3;␊
        }␊
    ␊
        function g() public {␊
