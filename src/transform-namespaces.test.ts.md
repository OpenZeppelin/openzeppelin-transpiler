...
## namespace override with @custom:override-namespace-id
...
> Snapshot 1
    ...
    contract NamespaceOverride1 {␊
        function __NamespaceOverride1_init() internal onlyInitializing {␊
        }␊
    ␊
        function __NamespaceOverride1_init_unchained() internal onlyInitializing {␊
        }␊
        /// @custom:storage-location erc7201:openzeppelin.storage.NamespaceOverride1␊
        struct NamespaceOverride1Storage {␊
            address x;␊
        }␊
    ␊
        // keccak256(abi.encode(uint256(keccak256("openzeppelin.storage.NamespaceOverride1")) - 1)) & ~bytes32(uint256(0xff))␊
        bytes32 private constant NamespaceOverride1StorageLocation = 0xe40e137e32a0c6a593e1de35447532edcc14e24fb9d30ecf870ad6d0f7025800;␊
    ␊
        function _getNamespaceOverride1Storage() private pure returns (NamespaceOverride1Storage storage $) {␊
            assembly {␊
                $.slot := NamespaceOverride1StorageLocation␊
            }␊
        }␊
    }␊
    ␊
    ...
    contract NamespaceOverride2 {␊
        /// @custom:storage-location erc7201:openzeppelin.storage.NamespaceOverride2␊
        struct NamespaceOverride2Storage {␊
            address x;␊
        }␊
    ␊
        // keccak256(abi.encode(uint256(keccak256("openzeppelin.storage.NamespaceOverride2")) - 1)) & ~bytes32(uint256(0xff))␊
        bytes32 private constant NamespaceOverride2StorageLocation = 0x9831d75025fa461788fb4f6f0fde10ed99c91399fcae103bd230cadbf7f67100;␊
    ␊
        function _getNamespaceOverride2Storage() private pure returns (NamespaceOverride2Storage storage $) {␊
            assembly {␊
                $.slot := NamespaceOverride2StorageLocation␊
            }␊
        }␊
        function __NamespaceOverride2_init() internal onlyInitializing {␊
            __NamespaceOverride2_init_unchained();␊
        }␊
    ␊
        function __NamespaceOverride2_init_unchained() internal onlyInitializing {␊
            NamespaceOverride2Storage storage $ = _getNamespaceOverride2Storage();␊
            $.x = msg.sender;␊
        }␊
    }␊
    ␊
    ...
    contract NamespaceOverride3 {␊
        function __NamespaceOverride3_init() internal onlyInitializing {␊
            __NamespaceOverride3_init_unchained();␊
        }␊
    ␊
        function __NamespaceOverride3_init_unchained() internal onlyInitializing {␊
            NamespaceOverride3Storage storage $ = _getNamespaceOverride3Storage();␊
            $.x = msg.sender;␊
        }␊
        /// @custom:storage-location erc7201:openzeppelin.storage.NamespaceOverride3␊
        struct NamespaceOverride3Storage {␊
            address x;␊
        }␊
    ␊
        // keccak256(abi.encode(uint256(keccak256("openzeppelin.storage.NamespaceOverride3")) - 1)) & ~bytes32(uint256(0xff))␊
        bytes32 private constant NamespaceOverride3StorageLocation = 0x3068a7a54c602bdd6c28682618d2ae37541177b766ad6e62996afa60ece51900;␊
    ␊
        function _getNamespaceOverride3Storage() private pure returns (NamespaceOverride3Storage storage $) {␊
            assembly {␊
                $.slot := NamespaceOverride3StorageLocation␊
            }␊
        }␊
    }␊
    ␊
    ...
    contract NamespaceOverride4 {␊
        /// @custom:storage-location erc7201:openzeppelin.storage.NamespaceOverride4␊
        struct NamespaceOverride4Storage {␊
            uint x; // a comment␊
    ␊
            uint y;␊
        }␊
    ␊
        // keccak256(abi.encode(uint256(keccak256("openzeppelin.storage.NamespaceOverride4")) - 1)) & ~bytes32(uint256(0xff))␊
        bytes32 private constant NamespaceOverride4StorageLocation = 0x2bb46ab7fe476755d0103e35e8d11cf254dc2b023e3890f7a1d6576b61e4a900;␊
    ␊
        function _getNamespaceOverride4Storage() private pure returns (NamespaceOverride4Storage storage $) {␊
            assembly {␊
                $.slot := NamespaceOverride4StorageLocation␊
            }␊
        }␊
    ␊
        function __NamespaceOverride4_init() internal onlyInitializing {␊
        }␊
    ␊
        function __NamespaceOverride4_init_unchained() internal onlyInitializing {␊
        }␊
        function f() public {␊
            NamespaceOverride4Storage storage $ = _getNamespaceOverride4Storage();␊
            $.x = 3;␊
        }␊
    ␊
        function g() public {␊
