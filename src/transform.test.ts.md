...
> Snapshot 1
    ...
    ␊
    import './Imported.sol';␊
    import {Initializable} from "./Initializable2.sol";␊
    ␊
    contract Local is Imported2 {␊
        constructor(uint x, uint y) Imported2(x, y) public { }␊
    }␊
...
## add requested public initializer skips abstract contracts
...
> Snapshot 1
    ...
    contract ConcreteWithArgs is AbstractWithArgs {␊
        function initialize(uint x) public virtual initializer {␊
            __ConcreteWithArgs_init(x);␊
        }␊
        constructor(uint x) public AbstractWithArgs(x) {}␊
    }␊
    `

## add requested public initializer skips abstract-only file
