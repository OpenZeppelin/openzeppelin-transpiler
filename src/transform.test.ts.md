...
> Snapshot 1
    ...
    ␊
    contract A {␊
      function __A_init(uint x) internal onlyInitializing {␊
        }␊
    ␊
        function __A_init_unchained(uint) internal onlyInitializing {}␊
    }␊
    ␊
    contract B is A {␊
    	function __B_init(uint x) internal onlyInitializing {␊
            __A_init_unchained(x);␊
        }␊
    ␊
        function __B_init_unchained(uint) internal onlyInitializing {}␊
    }␊
    ␊
    interface IFoo {␊
    ...
    ␊
    contract E is B {␊
    	function __E_init(IFoo t) internal onlyInitializing {␊
            __A_init_unchained(x);␊
            __B_init_unchained(t.mint());␊
        }␊
    ␊
        function __E_init_unchained(IFoo) internal onlyInitializing {}␊
    }␊
    ␊
    contract F is A {␊
      function __F_init(uint y) internal onlyInitializing {␊
            __A_init_unchained(y + 1);␊
        }␊
    ␊
        function __F_init_unchained(uint) internal onlyInitializing {}␊
    }␊
    ␊
    contract G is F {␊
      function __G_init() internal onlyInitializing {␊
            __A_init_unchained(y + 1);␊
            __F_init_unchained(4);␊
        }␊
    ␊
        function __G_init_unchained() internal onlyInitializing {}␊
    }␊
    `
