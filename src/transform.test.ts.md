...
> Snapshot 1
    ...
    ␊
    contract Foo5 {␊
        function __Foo5_init(function () external) internal onlyInitializing {␊
        }␊
    ␊
    ...
    contract Foo13 is Foo4 {␊
        function __Foo13_init(uint) internal onlyInitializing {␊
            __Foo4_init_unchained();␊
        }␊
    ␊
        function __Foo13_init_unchained(uint) internal onlyInitializing {␊
    ␊
        }␊
    }␊
    ␊
    ...
    ␊
        function __Foo14_init(uint a, uint) internal onlyInitializing {␊
            __Foo7_init_unchained(a);␊
