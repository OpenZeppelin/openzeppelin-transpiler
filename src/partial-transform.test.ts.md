...
> Snapshot 1

    {
      ...
      ␊
      contract SomeContractUpgradeable is Initializable, ISomeInterfaceUpgradeable {␊
...
## transpile SomeContract

> Snapshot 1

    undefined

## transpile SomeOtherContract
...
## transpile contracts/project/SomeContract.sol
...
> Snapshot 1
    ...
    pragma solidity ^0.6;␊
    ␊
    import { ISomeInterfaceUpgradeable } from "@openzeppelin/contracts/project/ISomeInterface.sol";␊
    import { SomeLibraryUpgradeable } from "@openzeppelin/contracts/project/SomeLibrary.sol";␊
    ␊
    contract SomeContract is ISomeInterfaceUpgradeable {␊
        function someFunction() public override returns (bool) {␊
            return false;␊
        }␊
    ␊
...
## transpile contracts/project/SomeOtherContract.sol
...
> Snapshot 1
    ...
    import { SomeContractUpgradeable } from "./SomeContractUpgradeable.sol";␊
    ␊
    contract SomeOtherContract is SomeContractUpgradeable {␊
        function extraFunction() public returns (uint256) {␊
            return 42;␊
        }␊
    }`
