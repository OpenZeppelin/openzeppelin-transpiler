...
> Snapshot 1
    ...
    {
      fileName: 'ElementaryTypesWithConstructorAndMigration.sol',
      path: 'contracts/solc-0.6/ElementaryTypesWithConstructorAndMigrationUpgradeable.sol',
      source: `pragma solidity ^0.6.0;␊
      import {Initializable} from "../Initializable.sol";␊
      ␊
      contract ElementaryTypesWithConstructorAndMigrationUpgradeable is Initializable {␊
          address public owner;␊
          bool active;␊
          string hello;␊
          int count;␊
          ...
          bytes32 samevar;␊
      ␊
          function __ElementaryTypesWithConstructorAndMigration_init() internal onlyInitializing {␊
              __ElementaryTypesWithConstructorAndMigration_init_unchained();␊
          }␊
      ␊
          function __ElementaryTypesWithConstructorAndMigration_init_unchained() internal onlyInitializing {␊
              owner = address(0x123);␊
              active = true;␊
              hello = "hello";␊
              count = -123;␊
      ...
      ␊
          function __ElementaryTypesWithConstructorAndMigration_migrate(int256 currentCount, uint256 currentUCount) internal onlyInitializer {␊
              owner = address(0x123);␊
              active = true;␊
              hello = "hello";␊
              count = currentCount;␊
