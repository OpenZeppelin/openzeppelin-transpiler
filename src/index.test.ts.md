...
> Snapshot 1

    {
      ...
      contract CIAUpgradeable is Initializable {␊
          uint256 public foo;␊
          event log(string);␊
          function __CIA_init(uint) internal onlyInitializing {␊
...
> Snapshot 1

    {
      ...
      contract Imported1Upgradeable is Initializable {␊
          function __Imported1_init(uint256, uint256) internal onlyInitializing {␊
          }␊
      ␊
      ...
      contract Imported2Upgradeable is Initializable, Imported1Upgradeable {␊
          function __Imported2_init(uint256, uint256) internal onlyInitializing {␊
          }␊
      ␊
...
> Snapshot 1

    {
      ...
      contract LocalUpgradeable is Initializable, Imported2Upgradeable {␊
          function __Local_init(uint, uint) internal onlyInitializing {␊
          }␊
      ␊
...
> Snapshot 1

    {
      ...
      contract StringConstructorUpgradeable is Initializable {␊
          function __StringConstructor_init(string memory) internal onlyInitializing {␊
          }␊
      ␊
