...
> Snapshot 1

    {
      ...
      contract CIAUpgradeable is Initializable {␊
          using CIAStorage for CIAStorage.Layout;␊
          uint256 public foo;␊
          uint256 public foo2;␊
          event log(string);␊
...
> Snapshot 1

    {
      ...
      contract ElementaryTypesWithConstructorUpgradeable is Initializable  {␊
          using ElementaryTypesWithConstructorStorage for ElementaryTypesWithConstructorStorage.Layout;␊
      ␊
...
> Snapshot 1

    {
      ...
      contract LocalUpgradeable is Initializable, Imported2Upgradeable {␊
          using LocalStorage for LocalStorage.Layout;␊
      ␊
          struct LocalStruct {␊
...
> Snapshot 1

    {
      ...
      contract SICUpgradeable is Initializable, SIBUpgradeable {␊
          using SICStorage for SICStorage.Layout;␊
          string public bar;␊
...

    {
      ...
      ␊
          function __RenameDeployer_init_unchained() internal onlyInitializing {␊
              rc = RenameContractUpgradeable(address(0));␊
